...
/// See also:
///
///  * [showDatePicker], which creates a Dialog that contains a [CalendarPicker]
...
class _DatePickerModeToggleButtonState
  ...
  Widget build(BuildContext context) {
    ...
    final Color controlColor = Color(0xFFEEEEEE);
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color controlColor =Color(0xFFD0D0D0);
...
class _YearPickerState extends State<_YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    final TextStyle itemStyle = TextStyle(color:Color(0xFFEEEEEE));
